...
- **Intent-driven routing.** Classifies the job into one of ten modes and picks the medium + cognitive load that fit the grade band, instead of one default template.
